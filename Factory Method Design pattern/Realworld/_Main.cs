...
namespace BridgeTechWhizz
{
    public class MainApp
    {
        static void Main()
        {
            Console.WriteLine("Create Resume for Higher Education (Creation of *Higher Education Resume* is happening in a separate factory class)\n------------------------");
            ...
            Console.WriteLine("\n\n");
            Console.WriteLine("Create Resume for Job (Creation of *Job Resume* is happening in a separate factory class)\n------------------------");
            ...
            Console.WriteLine("Create Resume for Higher Education (Creation of *Document pages of Higher Education Resume* is happening inside the concrete object)\n------------------------");
            ...
            Console.WriteLine("\n\n");
            Console.WriteLine("Create Resume for Job (Creation of *Document pages of Job Resume* is happening inside the concrete object)\n------------------------");
